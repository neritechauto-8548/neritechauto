    ...
    >
      @switch (name) {
        ...
        @case ('help-circle') {
          ...
          <path d="M12 17v.01" />
          <path d="M12 14a2.5 2.5 0 1 0-2.35-3.35" />
        }
        ...
        @case ('users') {
          ...
          <path d="M17 14a5 5 0 0 1 4 5v2" />
        }
        @case ('tool') {
          <path d="M14.7 6.3a4 4 0 0 0-5.4 5.4l-5.8 5.8a2 2 0 0 0 3 3l5.8-5.8a4 4 0 0 0 5.4-5.4l-2.4 2.4-3-3z" />
        }
        @case ('database') {
        ...
        @case ('file-invoice') {
          ...
          <path d="M5 3h9l5 5v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2" />
        ...
        @case ('receipt-tax') {
          <path d="M5 3v18l3-2 3 2 3-2 3 2 2-1.33V3l-3 2-3-2-3 2-3-2z" />
        ...
        @case ('report-analytics') {
          <path d="M4 19V5a2 2 0 0 1 2-2h9l5 5v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2" />
          <path d="M14 3v5h5" />
