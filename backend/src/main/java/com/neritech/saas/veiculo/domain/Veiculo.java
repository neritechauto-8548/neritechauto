...
public class Veiculo extends TenantEntity {
    ...
    @Size(max = 11, message = "O Renavam deve ter no máximo 11 caracteres")
    ...
    public MarcaVeiculo getMarca() { return marca; }
    public void setMarca(MarcaVeiculo marca) { this.marca = marca; }
    ...
    public void setAnoModelo(AnoModelo anoModelo) { this.anoModelo = anoModelo; }
    ...
    public Integer getQuilometragemAtual() { return quilometragemAtual; }
    public void setQuilometragemAtual(Integer quilometragemAtual) { this.quilometragemAtual = quilometragemAtual; }
    public Integer getQuilometragemCadastro() { return quilometragemCadastro; }
    public void setQuilometragemCadastro(Integer quilometragemCadastro) { this.quilometragemCadastro = quilometragemCadastro; }
    ...
    public Integer getProximaRevisaoKm() { return proximaRevisaoKm; }
    public void setProximaRevisaoKm(Integer proximaRevisaoKm) { this.proximaRevisaoKm = proximaRevisaoKm; }
    public LocalDate getProximaRevisaoData() { return proximaRevisaoData; }
    public void setProximaRevisaoData(LocalDate proximaRevisaoData) { this.proximaRevisaoData = proximaRevisaoData; }
