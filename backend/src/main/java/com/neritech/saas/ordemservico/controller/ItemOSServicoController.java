...
@Tag(name = "Itens OS Serviços", description = "Gerenciamento de serviços vinculados às ordens de serviço")
public class ItemOSServicoController {
    ...
    @Operation(summary = "Criar novo item de serviço")
    ...
    @Operation(summary = "Buscar item de serviço por ID")
    ...
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('GERAL_USUARIO')")
    @Operation(summary = "Listar itens de serviço por ordem de serviço")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('OS_INC_ITENS')")
    @Operation(summary = "Atualizar item de serviço")
    public ResponseEntity<ItemOSServicoResponse> update(
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('OS_INC_ITENS')")
    @Operation(summary = "Excluir item de serviço")
